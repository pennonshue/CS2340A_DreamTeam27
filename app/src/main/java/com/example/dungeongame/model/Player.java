...
package com.example.dungeongame.model;
    ...
    public class Player {
        ...
        public static com.example.dungeongame.model.Player getInstance(String username, int sprite, String difficulty, int speed) {
            if (userInstance == null) {
                userInstance = new com.example.dungeongame.model.Player(username, sprite, difficulty, speed);
            }
            return userInstance;
        }
